        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><a href="meetings.php" class="active">โปรแกรมนวด</a></li>
              <!-- <li><a href="index.php">Apply Now</a></li>
              <li class="has-sub">
                <a href="javascript:void(0)">Management</a>
                <ul class="sub-menu"> -->

              <!-- ข้างล่างเดี๋ยวทำลิ้งหน้ามาใส่ -->
        ...
        <div class="col-lg-12">
          <div class="row">
            <div class="col-lg-12">
              <div class="filters">
                <ul>
                  <li data-filter="*" class="active">body massage head and shoulders</li>
                ...
                <div class="col-lg-4 templatemo-item-col all soon">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="meeting-details.php"><img src="assets/images/Traditional-Thai.jpg" alt="" width="150" height="250"></a>
                    </div>
                    <div class="down-content">
                      ...
                      <p>Intense Ancient Yoga techniques used to release tension in muscles.</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 templatemo-item-col all imp">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="meeting-details.php"><img src="assets/images/sport.jpg" alt="" width="150" height="250"></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                ...
                <div class="col-lg-4 templatemo-item-col all soon">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="meeting-details.php"><img src="assets/images/scrub.jpg" alt="" width="150" height="250"></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
