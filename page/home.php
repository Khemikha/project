...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><a href="meetings.php">โปรแกรมนวด</a></li>
              ...
              <li class="scroll-to-section"><a href="#contact">เกี่ยวกับฉัน</a></li>
            </ul>
  ...
  <section class="section main-banner" id="top" data-section="section1">
    <video autoplay muted loop id="bg-video">
      <source src="assets/images/massage home.mp4" type="video/mp4" />
    </video>
    ...
    <div class="video-overlay header-text">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="caption">
              <h2>Passara Wellness And Spa</h2>
              <p>Experience our Wide Range of Authentic Thai Massage </a>.</p>
              <div class="main-button-red">
                <div class="scroll-to-section"><a href="#contact">Book a Massage Now!</a></div>
              </div>
            </div>
          </div>
        </div>
